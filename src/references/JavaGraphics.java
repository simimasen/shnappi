	...
	public void run() {
		while (Thread.currentThread() == animator) {
			...
			if (cloudDrift) {
				...
				// so that the cloud goes up and disappears at the top of the
				// screen
				if (cloudTracker > 500) {
					if (cloudTracker % 5 == 0)
						cloudY--;
			...
			if (starsComeOut) {
				...
				if (startedTwinkling) {
					int randNumber = random.nextInt(10); // Returns random int
															// >= 0 and < n

					switch (randNumber + 1) {
					case 1: // twinkle star 1
						star1Color = new Color(starR - 30, starG - 30,
								starB - 30);
						repaint();
						try {
						...
						star1Color = new Color(starR - 60, starG - 60,
								starB - 60);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						break;
					case 2: // twinkle star
						star2Color = new Color(starR - 30, starG - 30,
								starB - 30);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						star2Color = new Color(starR - 60, starG - 60,
								starB - 60);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						break;
					case 3: // etc
						star3Color = new Color(starR - 30, starG - 30,
								starB - 30);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						star3Color = new Color(starR - 60, starG - 60,
								starB - 60);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						break;
					case 4:
						star4Color = new Color(starR - 30, starG - 30,
								starB - 30);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						star4Color = new Color(starR - 60, starG - 60,
								starB - 60);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						break;
					case 5:
						star5Color = new Color(starR - 30, starG - 30,
								starB - 30);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						star5Color = new Color(starR - 60, starG - 60,
								starB - 60);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						break;
					case 6:
						star6Color = new Color(starR - 30, starG - 30,
								starB - 30);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						star6Color = new Color(starR - 60, starG - 60,
								starB - 60);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						break;
					case 7:
						star7Color = new Color(starR - 30, starG - 30,
								starB - 30);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						star7Color = new Color(starR - 60, starG - 60,
								starB - 60);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						break;
					case 8:
						star8Color = new Color(starR - 30, starG - 30,
								starB - 30);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						star8Color = new Color(starR - 60, starG - 60,
								starB - 60);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						break;
					case 9:
						star9Color = new Color(starR - 30, starG - 30,
								starB - 30);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						star9Color = new Color(starR - 60, starG - 60,
								starB - 60);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
					...
					case 10: // twinkle star 10
						star10Color = new Color(starR - 30, starG - 30,
								starB - 30);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
						...
						star10Color = new Color(starR - 60, starG - 60,
								starB - 60);
						repaint();
						try {
							Thread.sleep(60); // time in milliseconds
